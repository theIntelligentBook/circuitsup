    ...
    <.div(
      Common.marked(
        s"""
           ...
           |
           |* <code>A &and; B</code> - what you'd see on mathematical logic courses
           |* <code>A &middot; B</code> - engineers like to write it like a multiplication. Remember, anything times 0 is 0.
